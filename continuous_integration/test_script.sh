...
python -c "from tests.test_threadpoolctl import test_openmp_limit_num_threads, test_nested_prange_blas; test_openmp_limit_num_threads(4); test_nested_prange_blas(3)"
